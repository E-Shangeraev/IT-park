  ...
  return (
    <div className="slider">
        ...
        <div className="slider__bottom">
          <Slick className="second" ref={secondSliderRef} {...settings} fade>
            ...
            <p className="second__slide">
              ...
              exercitationem nemo error voluptates. Totam porro nobis labore
              illo? Facere beatae quam omnis eligendi?
            </p>
            <p className="second__slide">
              ...
              autem quos explicabo enim dolore aliquid assumenda error
              voluptatem iste qui sunt?
            </p>
          </Slick>
      ...
      <ul className="slider__switchers">
        <li>
          <button type="button">Комфортные рабочие места</button>
        </li>
        <li>
          <button type="button">Зона отдыха</button>
        </li>
        <li>
          <button type="button">Конференц-зал</button>
        </li>
        <li>
          <button type="button">2 комнаты для проведения переговоров</button>
        </li>
        <li>
          <button type="button">Кухня</button>
        </li>
      </ul>
    </div>
  )
